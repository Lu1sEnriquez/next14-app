...
import { IoBrowsersOutline, IoCalculator, IoFootball, IoHandRightOutline, IoHeartOutline, IoLogoReact } from 'react-icons/io5';
...
export const Sidebar = () => {
  return (
    ...
    <div id="menu" 
      className="fixed  bg-gray-900 min-h-screen z-10 text-slate-300 w-64 left-0 ">
